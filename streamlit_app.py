...
with st.sidebar:
    ...
    st.write("`Created by:`")
    linkedin_url = "https://www.linkedin.com/in/kumar-sambhav-b67142225/"
    st.markdown(f'<a href="{linkedin_url}" target="_blank" style="text-decoration: none; color: inherit;"><img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="25" height="25" style="vertical-align: middle; margin-right: 10px;">`Sambhav`</a>', unsafe_allow_html=True)
